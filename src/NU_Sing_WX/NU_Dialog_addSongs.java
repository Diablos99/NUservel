...
public class NU_Dialog_addSongs extends JDialog
{
	protected static JLabel addsongsLabel;
	protected static JPanel addsongsCenterPanel;
	
	public NU_Dialog_addSongs(JFrame owner, String labelContent)
	{
		...
		NU_Button.ok.setFont(front);
		JPanel addPanel = new JPanel();
		addPanel.setBackground(Color.black);													
		addPanel.add(NU_Button.ok);
